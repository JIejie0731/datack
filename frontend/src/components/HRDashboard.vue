<template>
  <div class="hr-dashboard" ref="dashboardRef">
    ...
    <div class="hr-section section-2">区域2</div>
    <div class="hr-section section-3">区域3</div>
  </div>
</template>
...
<style scoped>
.hr-dashboard {
  background: linear-gradient(to bottom, #1f2125 0%, #1f2125 20%, #f7f7f7 20%, #f7f7f7 100%);
  min-height: 100vh;
  display: flex;
...
.section-2 {
  height: 230px;
  border: 2px solid #ff3b3b; /* 红色边框，也可以改为 #000 黑色 */
